...
// "<script>" devient "&lt;script&gt;" : le navigateur l'affiche comme du
...
router.get('/bat-computer', isAuthenticated, (req, res) => {
    ...
    res.send(`
        ...
        <body class="container py-5">
                        <h1>Bienvenue, Justicier ${escapeHtml(user.username)}</h1>
            <p class="text-muted">Role : ${escapeHtml(user.role)}</p>
